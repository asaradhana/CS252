...
<html lang="en">
  <head>
    ...
    <?php
     $subject = file_get_contents('blog/index.html');
    $h1tags = preg_match_all('/<title>(.*)<\/title>/',$subject,$patterns);
    // echo $patterns[1][0]; 
    ?>
    <title><?php echo $patterns[1][0]; ?></title>
 ...
 -->
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title"><?php echo $patterns[1][0]; ?></h1>
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          <div class="sidebar-module sidebar-module-inset">
            ...
            <?php
             $subject = file_get_contents('blog/index.html');
           $h1tags = preg_match_all('/ <p id\="aboutblog">(.*)<\/p>/',$subject,$patterns);
              ?>
            <p id="aboutblog"><?php echo $patterns[1][0]; ?></p>
          </div>
...
$newfile=$date.'.html';
// echo $newfile;
$output = shell_exec('cp blog/index.html blog/'.$newfile);
$output = shell_exec('rm blog/index.html');
