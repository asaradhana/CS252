        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input name="firsttitle" type="text" class="form-control" id="firsttitle" placeholder="Title for your first blog entry">
              </div>
            </div>
            <div class="form-group">
              <label for="firstauthor" class="col-sm-2 control-label">Author</label>
              <div class="col-sm-10">
                <input name="firstauthor" type="text" class="form-control" id="firstauthor" placeholder="Author">
              </div>
            </div>
            <div class="form-group">
              <label for="firstblog" class="col-sm-2 control-label">Content</label>
              <div class="col-sm-10">
               <textarea name="firstblog" cols="100" rows="25" id="firstblog" placeholder="And here goes your very first blog post!!"></textarea>
			  </div>
            </div>
            <div class="form-group">
